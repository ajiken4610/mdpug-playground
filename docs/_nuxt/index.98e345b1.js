import{_ as u}from"./Markdown.f62a1afe.js";import{o as i,c,a as s,b as n,_ as d,f as p,r as t,q as w,s as g,w as k,d as M,x as $,y,z as P,A as E,h as H}from"./entry.5bee29ca.js";import{_ as N}from"./nuxt-link.8f696c2c.js";import"./katex.min.0a87eea6.js";const C={class:"px-2"},R={class:"flex h-16 flex-row items-center overflow-x-auto overflow-y-hidden w-auto"},T=s("hr",{class:"py-1"},null,-1);function D(l,o){const e=u;return i(),c("div",null,[s("div",C,[s("div",R,[n(e,{class:"flex-none",md:"#### **MDPug Playground**"}),n(e,{class:"flex-none pl-2",md:"Easy to run `MDPug`"})])]),T])}const I={},S=d(I,[["render",D]]),V=`# MDPug
**Markdown + Pug**
